\begin{recipe}[
    ...
    source = \textit{Fiery Ferments}; \textit{Pickl-It},
]
...
\step Add ingredients to jar. Prevent ingredients from floating up by starting with smaller pieces, then top off with a large dried pepper or cabbage leaf tucked down the sides of the jar.
...
\step Separate brine and ingredients, pur\`{e}e with $\approx1/2\;Cup$ brine added. Strain if desired; recommended if dried peppers are used.
