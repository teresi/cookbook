...
\begin{recipestats}[
	...
	preptime=30 minutes,
	bakingtime=4.5 hours,
	source=Pamela Teresi,
]
\end{recipestats}

\begin{recipeabstract}
	A post Thanksgiving tradition.
\end{recipeabstract}
...
\item Make roux: combine flour \& oil, stirring constantly on medium heat, $10...15\; min$ or until copper in color.

\item Add celery \& onions to roux, cook $5\; minutes$.

\item Add turkey, sausage, stock. Simmer $\sim 4\; hours$. \ragmarpar{Also serve w/ yeast rolls \& hot sauce}
