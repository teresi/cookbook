\section[Soft Pretzels]{Buttery Soft Pretzels~\vegan}\index{vegan!Soft Pretzels}\index{bread!Soft Pretzels}


\begin{recipestats}[
	servings=8 pretzels,
	preptime=\onehalf~\hour,
	inactivetime=1 \hour,
	bakingtime=20 \minute,
	source=Emma,
	original=\citefield{notChicken2019}{shorttitle}~\cite{notChicken2019},
]
\end{recipestats}
...
\begin{ingredientcolumns}
	\begin{ingredientblock}
		...
		\ingredient[1][\teaspoon]{malt powder}
	\end{ingredientblock}
	\begin{ingredientblock}
		\ingredient[1][\Tablespoon]{butter}\\
		\ingredient[4][C]{water, hot}\\
		\ingredient[\onefourth][C]{baking soda}\\
		\ingredient[\approx1][\Tablespoon]{pretzel salt}
	\end{ingredientblock}
\end{ingredientcolumns}

\ragmarpar{Diastatic malt powder helps produce that classic pretzel texture.}
\begin{preparation}
