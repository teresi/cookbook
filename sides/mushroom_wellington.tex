\section[Mushroom Wellington]{Mushroom Wellington\vegan}\index{mushroom!Mushroom Wellingto}\index{vegan!Mushroom Wellington}
...
\begin{preparation}
	...
	\ragmarpar{Parboiling the mushrooms limits the oil required to saut\'{e} them.}
