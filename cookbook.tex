...
% [ ] update minutes / min to use commands, standardize to abbreviation?
...
\usepackage{marginnote}         % notes in the margins
\usepackage[%
showframe,%
twoside,%
top=0.75in,%
