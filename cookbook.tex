...
\DeclareRobustCommand{\textfahrenheiht}{\ensuremath{^{\circ}\mathrm{F}}}
...
% FUTURE add forward on abbreviations (eg. oz vs fl. oz., Tbs tsp)
% TODO add custom ingredient command to make a 3col table (amount, unit, name)

\clearpage
\section{Breakfast}
\include{./breakfasts/egg_bites}
\include{./entrees/spinach_quiche}
