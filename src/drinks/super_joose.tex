\section[Super Joose]{
    Super Joose, or,\\Acid Adjusted Citrus
}\index{lemon!Super~Joose}\index{lime!Super~Joose}\index{orange!Super~Joose}\index{grapefruit!Super~Joose}
...
\begin{recipeabstract}
    ...
    The recipe addresses two issues: succinic acid causes oxidation, and the peels
    are normally wasted.
    The solution is to use an oleo citrate by dissolving the citrus oil with citric
    and malic acids, then combine it with the original juice.
    The overall reduction in succinic acid results in a longer shelf life and the
    incorporation of the peel produces a higher yield.
    Oleo citrate is very similar to oleo saccharum which uses sugar instead of acid,
    commonly used for punch\cite{oleoSaccharum}.
\end{recipeabstract}
...
\item Measure acids by weight compared to the weight of the peels.
    \ragmarpar{Rinse out jar w/ some water to get it all into the blender.}
\item Combine acids \& peels in a jar, shake, and macerate $[1..2]$ $\hour$.
\item Juice the fruit, combine everything (w/ peels), blend 2 \minute.
...
\ragmarpar{\citeauthor{superJuiceKosGrapefruitYT} advises grapefruit may not work well b/c peels are strongly flavored\cite{superJuiceKosGrapefruitYT}.}
    \begin{center}
