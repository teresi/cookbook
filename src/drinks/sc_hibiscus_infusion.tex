\section[SC Hibiscus Infusion]{
    SC Spiced Hibiscus Infusion
}\label{hibiscus_infusion}\index{hibiscus!Hibiscus~Infusion}
...
\begin{recipeabstract}
    ...
    Hibiscus has a sour and fruity flavor and known for it's use in Sorrel
    Punch and Agua de Jamaica.
