\section[Hotel Nacional]{
    Hotel Nacional Special\ragStars{2}
}\index{apricot!Hotel Nacional}\index{rum!Hotel Nacional}
...
\ragmarpar{Use lemon instead of lime if using canned
pineapple\cite{hotelNacionalColdGlass}.}
