\section[Airmail]{Airmail\ragStars{3}}\index{champagne!Airmail}\index{rum!Airmail}
...
\begin{recipeabstract}
    ...
    \citeauthor{cocktailSeminars2021} (the author) recommends the dry shake
    technique which unlocks the ``aromatic power'' of the honey and produces
    a light foam.
\end{recipeabstract}
