\section{
    Chili Schwarz
}\index{chili!Chili~Schwarz}\index{beef!Chili~Schwarz}\index{chili!Chili~Schwarz}
...
\begin{recipeabstract}
    This was an experiment on \nameref{chili_colorado_goat}~\ref{chili_colorado_goat}
    to use more black chilies and reduce cook time.
\end{recipeabstract}
...
\begin{ingredientcolumns}
    \begin{ingredientblock}
        ...
        \ingredient[\approx~\threehalf][lb]{ground beef}\\
        \ingredient[1]{onion, red}\\
        \ingredient[2][]{poblano}
    \end{ingredientblock}
    \begin{ingredientblock}
...
\begin{variation}
\item There is not a clear answer on whether or not to use the liquid used to
    re-hydrate the chilies.
