...
\begin{recipeabstract}
    ...
    The name is a play on the Giesken's balogna \& eggs recipe Hunka Punka. % FUTURE
    % add ref to Hunka Punka
\end{recipeabstract}
...
\item Meanwhile prepare the collards.
    Discard woody stems, slice leaves to $\approx1\times1''$, let soak in water w/ a
    dash of vinegar and salt.
...
\item Once collards are toasted, reduce heat a bit, expose center of pan by pushing
    mixture aside and add butter and garlic.
