\section{
    Handshake Focaccia
}\index{bread!Handshake~Focaccia}\index{vegan!Handshake~Focaccia}
...
\begin{recipeabstract}
    ...
    This is best eaten out of the oven and dipped in olive oil with a little
    salt and or-A-gaano (as they say in Britain).
\end{recipeabstract}

\begin{ingredientcolumns}
    \begin{ingredientblock}
        \ingredient[500][\gram]{bread flour}\\
        \ingredient[10][\gram]{diastatic malt powder}\\
...
\item Mix the dough.
    ...
    Continue mixing and gradually add water until all the flour is
    incorporated; water may be left over.
...
\item Prove the dough.
    Add each tray into a plastic bag and prove for $\approx 1$ \hour, until
