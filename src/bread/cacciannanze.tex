...
\begin{recipeabstract}
    ...
    \citeauthor{caraccioloPizza} provides many doughs, preparation methods,
    and focaccia recipes.
    This uses the 'quick' \cite[p.~83]{caraccioloPizza} dough with the stand
    mixer method,
...
\item Reserve a stand mixer, mixing bowl, large bowl, and a baking sheet
    $\approx 16~x~12$ $\inch$.
...
\item Mix on high until it sticks to the dough hook and doesn't tear when
