\section[Curry Rice]{Curry Rice, or, Kar\=e Raisu}\index{chicken!Curry~Rice}\index{curry!Curry~Rice}
...
\item Meanwhile, dice potatoes $\approx \sfrac{1}{2}~x~\sfrac{1}{2}~\inch$.
...
\item Add curry roux, stir well until completely dissolved.
    Optionally add black bean garlic sauce.
    Simmer $\approx5~\minute$.
...
\item Adding flavors to make it unique is common, e.g. tonkatsu,
    worcestershire, chocolate, coffee, ketchup, cream, etc.
\end{variation}
