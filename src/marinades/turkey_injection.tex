...
\begin{recipeabstract}
    ...
    If the label lists language such as ``injected with an 8\% solution of...'', then it is 'pre-brined' or
    'self-basted'.
...
% coarse flake salt, paprika, ground chipotle pepper, black pepper, cayenne red pepper, thyme, rosemary and
% granulated garlic
