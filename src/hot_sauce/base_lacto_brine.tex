\section[Brined Hot Sauce]{Base Brined Hot Sauce}\label{base_lacto_brine_hotsauce}
...
\begin{recipeabstract}
    ...
    Peppers are fermented whole and then pur\`{e}ed rather than mashed prior to fermentation, see
    ``Mixed-Media Basic Mash''~\cite{fieryferments2017}.
\end{recipeabstract}
