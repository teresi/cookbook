...
\begin{recipeabstract}
    ``Chili Colorado. It's a traditional Mexican dish of beef or pork stewed in a red chili sauce, chili
    'colored red,' not chili from the state of Colorado'' \cite{rMartinez2015}.
...
\item Serve with tortillas, and the carrots from \nameref{mexican_beef_bowl}~\ref{mexican_beef_bowl}.
    \citeauthor{rMartinez2015} recommends rice, beans a la charra, and tortillas.
\end{variation}
