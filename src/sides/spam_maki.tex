\section{Spam Maki}\index{Spam!Spam~Maki}\index{soy sauce~Spam~Maki}
...
\item Assemble. Lay the nori on the mat shiny side down. Spread a $\approx\onefourth~inch$ layer of rice and
    leave a $1 \onehalf~inch$ empty space of nori at the top.
