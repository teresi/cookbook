\section[Felix Cookies]{
    Felix Cookies, or,\\ \mbox{Schwarz-Wei\ss-Geb\"{a}ck}
}\index{cookie!Felix~Cookies}\index{chocolate!Felix~Cookies}
...
\begin{preparation}
    \ragmarpar{Try other shapes: 6 petal flowers, spirals, etc.}
...
\item Mix milk \& egg yolk in a small bowl.
    ...
    \ragmarpar{Don't over bake, add a sheet below to shield the radiation}
\item Make 4 square logs, brush sides w/ egg wash, press together and
    refrigerate $\approx 30$ \minute.
