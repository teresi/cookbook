\section[Strawberry Rhubarb Pie]{
    Strawberry Rhubarb Crumb Pie
}\index{strawberry!Strawberry~Rhubarb~Pie}\index{rhubarb!Strawberry~Rhubarb~Pie}
...
\end{recipeabstract}
% NOTE two-col ingredients won't print right if there's not enough space, is
% there a better way?
...
\begin{preparation}
\item Prepare~\ref{basicFlakyPiePastry} \nameref{basicFlakyPiePastry} and
    refrigerate $\geq 1$ \hour.
...
\item Prepare filling.
    Slice rhubarb $\approx \onehalf''$ pieces, mix fruit w/ sugar, lemon
    juice, zest, tapioca.
