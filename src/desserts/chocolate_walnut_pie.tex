\section[Chocolate Walnut Pie]{
    Chocolate Cr\`{e}me de Cacao\\ Walnut Pie
}\index{chocolate!Chocolate~Walnut~Pie}\index{chocolate!Chocolate~Walnut~Pie}
...
\ragmarpar{Bring eggs to room temperature.}
...
\begin{preparation}
\item Prepare pastry~\ref{basicFlakyPiePastry}~\nameref{basicFlakyPiePastry},
    partially pre-bake, and let cool.
...
\begin{variation}
\item Server with whip cream and / or vanilla ice cream.

\item \citeauthor{pie2004}~\cite{pie2004} recommends a nut pastry, and trying
    Kahl\'{u}a in place of cr\`{e}me de cacao.
\end{variation}
